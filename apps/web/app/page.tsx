...
export default function Home(){
  return (
    <div className='min-h-screen bg-gradient-to-b from-background to-muted flex flex-col items-center justify-center p-4'>
     <div className='max-w-2xl text-center space-y-8'x>
        ...
        <div className='flex gap-4 justify-center'>
          <Link href="/signin"><Button size="lg" variant="default">Get Started</Button></Link>
          <Link href='/signup'><Button size="lg" variant="outline">Sign Up</Button></Link>
        </div>
     </div>
    </div>
  )
